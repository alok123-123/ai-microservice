...
import { LogIn, Shield, Key, User, Lock, AlertTriangle } from 'lucide-react';
      ...
      <main className="w-full max-w-[420px] relative z-10">
        ...
        <Card className="p-8 backdrop-blur-2xl bg-card/60">
          ...
          <div className="mt-8 text-center pt-6 border-t border-border">
            <Link to="/register" className="text-xs font-mono text-text-secondary hover:text-accent transition-colors">
